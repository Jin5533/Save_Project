...
namespace Save_Project
{
    public partial class Form1 : Form
    {
        ...
        {
            MessageBox.Show("เครื่องคิดเลข จัดทำโดย นายโยเซฟ มูฮำมัด มูซา 16.3 รหัส 553266120", "เกี่ยวกับ");
        }

        private void เกยวกบToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
